...
export class AttributeService {
  ...
  private addAttributeUrl =
    this._config.apiBaseUrl + this.service + "add-attribute";
  private editAttributeUrl =
    this._config.apiBaseUrl + this.service + "edit-attribute/";
  private getAttributeUrl =
    this._config.apiBaseUrl + this.service + "getAttributes/";
  private countAttributeUrl =
    this._config.apiBaseUrl + this.service + "count-attribute";
  ...
  countAttribute() {
    return this._http.get<any>(this.countAttributeUrl);
  }
}
